...
const TABELAS = [
  ...
  { key: 'liberacoes_faltas', nome: 'Liberacoes de Faltas', aba: 'LiberacoesFaltas' },
  ...
  { key: 'experiencia_decisoes', nome: 'Experiencia Decisoes', aba: 'ExperienciaDecisoes' },
  { key: 'treinamentos_previsao', nome: 'Treinamentos Previsao', aba: 'TreinPrevisao' },
  { key: 'armarios_femininos', nome: 'Armarios Femininos', aba: 'ArmariosFem' },
  { key: 'armarios_config', nome: 'Config Armarios', aba: 'ArmariosConfig' },
  { key: 'armarios_link_bloqueios', nome: 'Bloqueios Link Armarios', aba: 'ArmariosBloqLink' },
  { key: 'armarios_setores_prestadores', nome: 'Setores Prestadores Armarios', aba: 'ArmariosSetPrest' },
  { key: 'sistema_config', nome: 'Config Sistema', aba: 'SistemaConfig' },
  { key: 'force_logout', nome: 'Logout Forcado', aba: 'ForceLogout' },
  { key: 'integracoes_agencia', nome: 'Integracoes Agencia', aba: 'IntegracoesAg' },
  { key: 'meal_records', nome: 'Refeicoes Prestadores', aba: 'MealRecords' },
  { key: 'meal_types', nome: 'Tipos Refeicao', aba: 'MealTypes' },
  { key: 'fretado_imports', nome: 'Importacoes Fretado', aba: 'FretadoImports' },
  { key: 'fretado_trips', nome: 'Viagens Fretado', aba: 'FretadoTrips' },
  { key: 'fretado_itinerarios', nome: 'Itinerarios Fretado', aba: 'FretadoItinerarios' },
  { key: 'fretado_valores_extras', nome: 'Valores Extras Fretado', aba: 'FretadoExtras' },
  { key: 'prestadores_funcionarios', nome: 'Prestadores Funcionarios', aba: 'PrestadoresFunc' },
  { key: 'prestadores_usuarios', nome: 'Prestadores Usuarios', aba: 'PrestadoresUsers' },
  { key: 'valor_historico', nome: 'Historico de Valores', aba: 'ValorHistorico' },
  { key: 'rateio_meses_fechados', nome: 'Rateio Meses Fechados', aba: 'RateioMeses' },
];
